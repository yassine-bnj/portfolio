...
# [Built Portfolio With GitHub ](https://github.com/yassine-bnj/yassine-bnj-Portfolio)
...
### Then, Customize data in the `utils/data` [folder](https://github.com/yassine-bnj/yassine-bnj-Portfolio/tree/main/utils/data).

Eg:

```javascript
export const personalData = {
  name: "yassine ben jeddou",
  profile: '/profile.png',
  designation: "Computer Engineer",
  description: "My name is yassine ben jeddou. I am a professional and enthusiastic programmer in my daily life. I am a quick learner with a self-learning attitude. I love to learn and explore new technologies and am passionate about problem-solving. I love almost all the stacks of web application development and love to make the web more open to the world. My core skill is based on JavaScript and I love to do most of the things using JavaScript. I am available for any kind of job opportunity that suits my skills and interests.",
  email: 'yassinebenjeddou5@gmail.com',
  phone: '+36205518200',
  address: 'Avignon, France',
  github: 'https://github.com/yassine-bnj',
  facebook: 'https://www.facebook.com/yassine.benjeddou.9',
  linkedIn: 'https://www.linkedin.com/in/yassine-ben-jeddou-8a2a09213/',
  twitter: 'https://twitter.com/',
  stackOverflow: 'https://stackoverflow.com',
  leetcode: "https://leetcode.com/u/yassine-bnj/",
  devUsername: "yassine-bnj",
